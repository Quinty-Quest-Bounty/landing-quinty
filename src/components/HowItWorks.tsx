...
export function HowItWorks() {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute left-[60px] md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-accent/10 to-transparent" />
          ...
          {steps.map((step) => (
            <div key={step.num} className="step-item flex gap-6 md:gap-10 items-start">
              ...
              <div className="pt-1.5">
                <h3 className="text-xl md:text-2xl font-semibold text-white/85 mb-2 tracking-tight">
                  {step.title}
                </h3>
